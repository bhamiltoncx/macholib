...
class MachO(object):
    ...
    If ignore_unknown_load_commands is True, ignores unknown load commands.
    ...
    def __init__(self, filename, ignore_unknown_load_commands=False):
        ...
        self.fat = None
        self.headers = []
        self.ignore_unknown_load_commands = ignore_unknown_load_commands
    ...
    def load_header(self, fh, offset, size):
        ...
        hdr = MachOHeader(self, fh, offset, size, magic, hdr, endian, self.ignore_unknown_load_commands)
...
class MachOHeader(object):
    ...
    def __init__(self, parent, fh, offset, size, magic, hdr, endian, ignore_unknown_load_commands=False):
        self.MH_MAGIC = magic
    ...
    def load(self, fh):
        ...
        for i in range(header.ncmds):
            ...
            if klass is None:
                if not self.ignore_unknown_load_commands:
